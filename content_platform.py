...
<div class="hub" id="hub-demo">
 ...
 <div class="hub-view hidden" data-view="session"><div class="sess-grid"><div><div class="player"><div class="player-img"></div><span class="bc-live">● LIVE</span><div class="player-lower"><b>Keynote: Events that survive contact with reality</b><span>Main stage · 09:30–10:15</span></div><div class="cc">Captions: "…and the run order is the document that lets the gallery anticipate…"</div></div><div class="sess-meta"><span>1,214 watching</span><span>Latency: 3s</span><span class="demo-link" role="note">Slides ↓</span><span class="demo-link" role="note">Transcript ↓</span><span class="demo-link" role="note">Add to calendar</span></div></div><div class="sess-side"><div class="tabs"><button class="on" data-stab="qa">Q&amp;A</button><button data-stab="poll">Poll</button><button data-stab="chat">Chat</button></div><div id="sess-qa"></div></div></div></div>
