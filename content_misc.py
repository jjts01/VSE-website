...
<div><label for="b-platform">Platform</label><select id="b-platform"><option value="0">Existing (Teams/Zoom/YouTube)</option><option value="1500" selected>Third-party event platform (typical licence)</option><option value="4000">Bespoke branded platform</option></select></div>
